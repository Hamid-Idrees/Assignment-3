...
public class CricketBoard {
    ...
    public static void main(String[] args) {
        ...
        String[] team1Players = {"Player1", "Player2", "Player3", "Player4", "Player5", "Player6", "Player7", "Player8", "Player9", "Player10", "Player11"};
        String[] team2Players = {"PlayerA", "PlayerB", "PlayerC", "PlayerD", "PlayerE", "PlayerF", "PlayerG", "PlayerH", "PlayerI", "PlayerJ", "PlayerK"};
        ...
        if (ScoreOfTeam1 > ScoreOfTeam2) {
            System.out.println("Winner of the match is " + team1);
        } else if (ScoreOfTeam2 > ScoreOfTeam1) {
            System.out.println("Winner of the match is " + team2);
        } else {
